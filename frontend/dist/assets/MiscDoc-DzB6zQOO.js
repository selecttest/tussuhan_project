import{B as w,c as v,o as u,p as l,l as S,U as T,a as i,m as L,X as $,W as y,aA as V,E as M,af as W,K as U,j as z,w as h,k as C,M as E,N as F,T as O,t as G,d as n,r as J,e as Q,aW as Z,F as ee}from"./index-CR1fBkFt.js";import{s as te}from"./index-CuHJ_4ki.js";import{s as ne}from"./index-BsvjCUg4.js";import{s as re}from"./index-CJ5seri0.js";import{s as R}from"./index-CgBZmSqV.js";import{a as A}from"./index-DHfXBsC3.js";import{s as ae}from"./index-DyQCrhjQ.js";var se=`
    .p-skeleton {
        display: block;
        overflow: hidden;
...
`,Ue={root:function(e){var s=e.props;return["p-avatar p-component",{"p-avatar-image":s.image!=null,"p-avatar-circle":s.shape==="circle","p-avatar-lg":s.size==="large","p-avatar-xl":s.size==="xlarge"}]},label:"p-avatar-label",icon:"p-avatar-icon"},Ce=w.extend({name:"avatar",style:Te,classes:Ue}),Ee={name:"BaseAvatar",extends:S,props:{label:{type:String,default:null},icon:{type:String,default:null},image:{type:String,default:null},size:{type:String,default:"normal"},shape:{type:String,default:"square"},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:Ce,provide:function(){return{$pcAvatar:this,$parentInstance:this}}};function x(t){"@babel/helpers - typeof";return x=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},x(t)}function D(t,e,s){return(e=Fe(e))in t?Object.defineProperty(t,e,{value:s,enumerable:!0,configurable:!0,writable:!0}):t[e]=s,t}function Fe(t){var e=Re(t,"string");return x(e)=="symbol"?e:e+""}function Re(t,e){if(x(t)!="object"||!t)return t;var s=t[Symbol.toPrimitive];if(s!==void 0){var o=s.call(t,e);if(x(o)!="object")return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(t)}var K={name:"Avatar",extends:Ee,inheritAttrs:!1,emits:["error"],methods:{onError:function(e){this.$emit("error",e)}},computed:{dataP:function(){return T(D(D({},this.shape,this.shape),this.size,this.size))}}},Xe=["aria-labelledby","aria-label","data-p"],Ie=["data-p"],Ye=["data-p"],qe=["src","alt","data-p"];function Ke(t,e,s,o,d,r){return u(),v("div",l({class:t.cx("root"),"aria-labelledby":t.ariaLabelledby,"aria-label":t.ariaLabel},t.ptmi("root"),{"data-p":r.dataP}),[L(t.$slots,"default",{},function(){return[t.label?(u(),v("span",l({key:0,class:t.cx("label")},t.ptm("label"),{"data-p":r.dataP}),G(t.label),17,Ie)):t.$slots.icon?(u(),z(F(t.$slots.icon),{key:1,class:E(t.cx("icon"))},null,8,["class"])):t.icon?(u(),v("span",l({key:2,class:[t.cx("icon"),t.icon]},t.ptm("icon"),{"data-p":r.dataP}),null,16,Ye)):t.image?(u(),v("img",l({key:3,src:t.image,alt:t.ariaLabel,onError:e[0]||(e[0]=function(){return r.onError&&r.onError.apply(r,arguments)})},t.ptm("image"),{"data-p":r.dataP}),null,16,qe)):C("",!0)]})],16,Xe)}K.render=Ke;var je=`
    .p-overlaybadge {
        position: relative;
    }
